var DOCUMENTATION_VERSIONS = {
    ...
    VERSIONS: [
        ...
        { name: "v4.4.1", old:false, has_targets:true, supported_targets: [ "esp32", "esp32s2", "esp32s3", "esp32c3" ]},
        { name: "v4.4", old:true, has_targets:true, supported_targets: [ "esp32", "esp32s2", "esp32s3", "esp32c3" ]},

        { name: "v4.3.2", old:false, has_targets: true, supported_targets: [ "esp32", "esp32s2", "esp32c3" ]},
        { name: "v4.3.1", old:true, has_targets: true, supported_targets: [ "esp32", "esp32s2", "esp32c3" ]},
        { name: "v4.3", old:true, has_targets: true, supported_targets: [ "esp32", "esp32s2", "esp32c3" ]},

        { name: "v4.2.3", old: false, has_targets: true, supported_targets: [ "esp32", "esp32s2" ]},
        { name: "v4.2.2", old: true, has_targets: true, supported_targets: [ "esp32", "esp32s2" ]},
        ...
        { name: "v4.1.3", old: false },
        { name: "v4.1.2", old: true },
        ...
        { name: "release-v4.4", pre_release: true, has_targets: true, supported_targets: [ "esp32", "esp32s2", "esp32c3", "esp32s3" ]},
