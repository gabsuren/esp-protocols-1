...
/**
 * @brief      Set reconnect timeout for client.
 *
 *  Notes:
 *  - This also updates an already active reconnection delay, if any: the new timeout is applied to the
 *    in-progress wait immediately (the client reconnects sooner or later accordingly).
 *
 * @param[in]  client             The client
